    ...
    return (
      <div className="DataDash">
        ...
        <div>
          <table>
            <tbody>
              <tr><td className="tdLabel">Height: </td><td>{data.curr_block}</td></tr>
              <tr><td className="tdLabel">Timestamp: </td><td>{data.blocks[0].timestamp}</td></tr>
              <tr><td className="tdLabel">Hashrate: </td><td>{data.hashrate}</td></tr>
              <tr><td className="tdLabel">Gas Price: </td><td>{gasPrice}</td></tr>
              <tr><td className="tdLabel">Gas Limit: </td><td>{gasLimit}</td></tr>
              <tr><td className="tdLabel">Dificulty: </td><td>{difficulty}</td></tr>
